...
> **Superseded on 2026-09-18.** The student adopted the integrated objective with the QEMU-only execution amendment as [plan v2.0](../governance/INTEGRATED_DEVELOPMENT_PLAN_2026.md), and the scope it governs is [`scope_and_rqs.md`](scope_and_rqs.md) version 2.0. The two-layer framing below is therefore historical. This unapproved August proposal was never sent and is not what the student reports confirmed. **Dated pointer, 2026-09-19:** the academic title and the research-question wording are now recorded as **reported approved by the student** under D011 — reported, undated and not a documented supervisor decision — in the integrated framing, not this two-layer one; the student's adoption settles execution only. Preserved text below is historical, including its unsupported x86 attribution for the base paper — the paper's evaluation hardware ISA is unspecified and that attribution is not carried forward; do not reuse any of it as a current factual description.
