...
Nota de 08/08 (atualizada apos os blocos P1a-P1c e P2 da ordem de trabalhos): R18, R19, R20 e R22 foram corrigidos em M2 (prova live pendente); a reanálise externa acrescentou RA1–RA15 — RA5/RA6/RA7/RA8/RA9/RA10 foram absorvidos pelas correções P1a–P1c, RA2/RA3 pelo bloco P2, RA11 fecha com a evidência re-selada em HEAD limpo, e RA13 equivale a R25. Referências originais: R18, R19 e R22 (correções do harness), R21 (marker `integration`
