...
| [`setup/qemu_integrated_gateway.md`](setup/qemu_integrated_gateway.md) | Runbook for the integrated QEMU/TCG gateway profile (Yocto ARM64 guest emulated on the x86-64 host, six containers inside the guest). **Unbuilt proposal**: nothing in it has been built, booted or run; Sections 4-9 also need later deployment changes. Rationale and package audit: [`reviews/2026-09-17-egw-image-audit.md`](reviews/2026-09-17-egw-image-audit.md) |
