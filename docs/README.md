...
- [ADR 0008](adr/0008-integrated-yocto-arm64-evaluation.md): Accepted by the
  ...
  student, academic use of emulated results (D014) not agreed.

**The supervisor position has two halves.** The alignment package covering what
remains open — the thresholds (D007), the academic use of emulated results
(D014), the authenticity of the local template copy inside D004 and the storage
semantics inside D010 — **has not been sent**, and D001, D007, D008 and D012 are
